...
class TestAccountReports(TestAccountReportsCommon):
    ...
    def test_partner_ledger_unknown_partner(self):
        ''' Test the partner ledger for whennever a line appearing in it has no partner assigned. Check that reconciling this line with an invoice/bill
        of a partner does effect his balance. '''
        ...
        #create misc entry with 1000 on a receivable account, without partner
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('partner_c',                           -1215.00,       345.00,         100.00,         -970.00),
                ('partner_d',                           -1295.00,       345.00,         0.00,           -950.00),
                ('Unknown Partner',                     0.00,           0.00,           1000.00,        -1000.00),
                # Report Total.
                ('Total',                               -1780.00,       990.00,         1790.00,        -2580.00),
            ],
        )

        #reconcile that line without partner with an invoice of 115 of partner_a
        inv1 = self.env['account.move.line'].search([('partner_id', '=', self.partner_a.id), ('account_id', '=', receivable_account_1.id), ('debit', '=', 115)], limit=1)
        (inv1 + misc_move.line_ids)\
        ...
        self.assertLinesValues(
            ...
            [
                # Partners.
                ('partner_a',                           665.00,         300.00,         460.00,         505.00),
                ('partner_b',                           65.00,          0.00,           345.00,         -280.00),
                ('partner_c',                           -1215.00,       345.00,         100.00,         -970.00),
                ('partner_d',                           -1295.00,       345.00,         0.00,           -950.00),
                ('Unknown Partner',                     0.00,           115.00,         1000.00,         -885.00),
                # Report Total.
                ('Total',                               -1780.00,       1105.00,        1905.00,        -2580.00),
            ],
        )
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('Unknown Partner',           '',         '',            '',       0.00,           115.00,       1000.00,         -885.00),
                # Account Move Lines.
                ('03/31/2017',            'MISC',    '121000',           '',       0.00,           '',           1000.00,         -1000.00),
                ('03/31/2017',            'MISC',    '121000',           '',       -1000.00,       115.00,       '',              -885.00),
            ],
        )

        # change the dates to exclude the reconciliation max date: situation is back to the beginning
        options = self._init_options(report, *date_utils.get_month(self.mar_year_minus_1))
        options['date']['date_to'] = '2017-03-30'
        ...
        options['date']['date_from'] = '2017-04-01'
        options['date']['date_to'] = '2017-04-02'
        lines = report._get_lines(options)
        self.assertLinesValues(
            lines,
            #   Name                                    Init. Balance   Debit           Credit          Balance
            ...
            [
                # Partners.
                ('partner_a',                           505.00,         0.00,           0.00,           505.00),
                ('partner_b',                           -280.00,        0.00,           0.00,           -280.00),
                ('partner_c',                           -970.00,        0.00,           150.00,         -1120.00),
                ('partner_d',                           -950.00,        0.00,           0.00,           -950.00),
                ('Unknown Partner',                     -885.00,        0.00,           0.00,           -885.00),
                # Report Total.
                ('Total',                               -2580.00,       0.00,           150.00,         -2730.00),
            ],
        )
    ...
    def test_tax_report_comparison_filter(self):
        ''' Test taxes lines. '''
        # Init options.
        ...
        self.assertLinesValues(
            ...
            [
                ('Sales',                               '',             '',             '',             '',             '',             ''),
                ('Tax 15.00% (15.0)',                   600.00,         90.00,          400.00,         60.00,          300.00,         45.00),
                ('Purchases',                           '',             '',             '',             '',             '',             ''),
                ('Tax 15.00% (15.0)',                   600.00,         90.00,          400.00,         60.00,          100.00,         15.00),
            ],
        )
    ...
    def test_tax_report_grid_cash_basis(self):
        ...
        report_lines_dict = {
            'sale': self._create_tax_report_line('Sale', test_country, sequence=1, tag_name='sale'),
            'purchase': self._create_tax_report_line('Purchase', test_country, sequence=2, tag_name='purchase'),
        }
